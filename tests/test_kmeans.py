...
def test_data():
    ...
    #x_path = os.path.join(os.path.dirname(__file__), "bow.npz")
    #idx_to_vocab_path = os.path.join(os.path.dirname(__file__), "idx_to_vocab.json")
    #x = sp.load_npz(x_path)
    #idx_to_vocab = json.load(open(idx_to_vocab_path))
